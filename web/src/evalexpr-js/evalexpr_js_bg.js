import * as wasm from './evalexpr_js_bg.wasm';
...
export class JsEvalexprContext {
    ...
    static __wrap(ptr) {
        const obj = Object.create(JsEvalexprContext.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_jsevalexprcontext_free(ptr);
    }
    /**
    */
    constructor() {
        const ret = wasm.jsevalexprcontext_new();
        return JsEvalexprContext.__wrap(ret);
    }
    /**
    * @param {string} line
    * @returns {any}
    */
    eval(line) {
        ...
        const ret = wasm.jsevalexprcontext_eval(this.ptr, ptr0, len0);
    ...
    */
    set_value(id, v) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.jsevalexprcontext_set_value(this.ptr, ptr0, len0, addBorrowedObject(v));
        } finally {
    ...
    */
    get_value(id) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.jsevalexprcontext_get_value(this.ptr, ptr0, len0);
        return takeObject(ret);
    }
}
...
export function __wbg_error_f1997173a4d1a609(arg0, arg1) {
